...
Usage:
    python -m twospeed.evals            # cloud models (spends tokens; needs the [cloud] extra)
    python -m twospeed.evals --fakes    # free smoke run on the fakes (expect failures)
    python -m twospeed.evals --only berlin   # scenarios whose name contains "berlin"
